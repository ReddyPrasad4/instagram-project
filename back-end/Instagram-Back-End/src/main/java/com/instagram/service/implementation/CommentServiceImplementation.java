...
public class CommentServiceImplementation implements CommentService {
    ...
    public ResponseEntity<BaseResponseDTO> createComment(CommentDTO commentDTO , String userName) {
        ...
        try {
            if (!ObjectUtils.isEmpty(commentDTO) && !ObjectUtils.isEmpty(commentDTO.getPostDto().getId()) && StringUtils.isNotEmpty(commentDTO.getCommentText()) && StringUtils.isNotEmpty(userName)) {
    ...
    public ResponseEntity<List<CommentDTO>> getAllCommentsOfAPost(UUID postId) {
        ...
        try {
            if (!ObjectUtils.isEmpty(postId)) {
                List<Comment> commentList = commentRepository.findByPostIdAndIsDeletedAndUserIsDeleted(postId, Boolean.FALSE,Boolean.FALSE);
